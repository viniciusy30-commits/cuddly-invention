    ...
    suspend fun check(context: Context): AccessDecision {
        ...
        return try {
            ...
            if (!snapshot.exists()) {
                ...
                // pending and deny access until the admin approves it. Also
                // check whether this physical device has registered before
                // under a different install (reinstall trying to farm a new
                // free trial) and flag it for the admin if so.
